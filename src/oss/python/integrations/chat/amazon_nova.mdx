...
Amazon Nova supports tool calling (function calling) on compatible models. You can check if a model supports tool calling using the model capabilities:

```python
from langchain_amazon_nova import ChatAmazonNova, get_model_capabilities

# Check model capabilities
capabilities = get_model_capabilities("nova-2-lite-v1")
print(f"Supports tool calling: {capabilities.supports_function_calling}")
```
...
Amazon Nova provides different models with varying capabilities. You can programmatically check model features:

```python
from langchain_amazon_nova import get_model_profile

# Get detailed capabilities
capabilities = get_model_capabilities("nova-2-lite-v1")
print(f"Max Output Tokens: {capabilities.max_output_tokens}")
print(f"Supports tool calling: {capabilities.tool_calling}")
print(f"Supports vision: {capabilities.image_inputs}")
```
...
```python
from langchain_amazon_nova import validate_tool_calling
